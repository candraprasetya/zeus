...
export const fr = {
  ...
  "startup": {
    ...
    "slowBody": "Zeus AI met plus de temps que d'habitude à joindre votre service local. Le démarrage peut encore aboutir de lui-même — vous pouvez patienter ou récupérer d'abord les journaux.",
    "stalledTitle": "Zeus AI n'a pas pu terminer son démarrage",
  ...
  "tray": {
    ...
    "viewMore": "Voir plus…",
    "open": "Ouvrir Zeus AI",
    "quit": "Quitter Zeus AI",
    "askTitle": "Garder Zeus AI en arrière-plan ?",
    "askBody": "Lorsque vous fermez la fenêtre, Zeus AI peut continuer à s'exécuter dans la barre d'état système afin que rien ne soit perdu. Vous pouvez modifier cela à tout moment dans les paramètres.",
    "closeToTray": "Près du bac",
    "confirmQuitTitle": "Quitter Zeus AI ?",
  ...
  "chat": {
    ...
    "placeholder": "Demandez à Zeus AI de vous aider pour tout",
...
"slashCommandSourceUnavailable": "Liste des commandes indisponible, rien n'a été envoyé. Réessayez.",
  ...
  "settings": {
    ...
    "keepAwakeWhileRunningDesc": "Empêche la veille due à l'inactivité pendant l'exécution de Zeus AI. L'écran peut s'éteindre ; la veille manuelle et la fermeture du capot restent possibles.",
...
sklm: {
    ...
    "pluginProviderKeyHint":
      "Stockée dans Zeus AI et utilisée par l'environnement d'exécution. Le plugin ne la reçoit jamais.",
  ...
  "scheduled": {
    "description": "Exécutez des tâches récurrentes tant que Zeus AI est ouvert.",
    ...
    "localTimeHint": "Utilise le fuseau horaire local. Gardez Zeus AI ouvert ; les exécutions manquées sont ignorées.",
  ...
  "panel": {
    ...
    "mindmap": {
      "title": "Carte mentale des connaissances",
      "emptyTitle": "Pas encore de graphe de connaissances",
      "emptyBody": "Exécutez /zeus-pantau dans le chat ou ajoutez des notes dans .knowledge/.",
...
"importConfirm": "Les extensions importées s’exécutent dans le processus de l’agent avec les mêmes droits que ses outils. Les compétences déclarées peuvent ajouter des instructions à l’agent et les dépendances déclarées sont installées avec npm (scripts d’installation désactivés). Continuer ?",
    ...
    "permissionHelp": {
      ...
      "provider.register": "Ajoute les fournisseurs définis par ce plugin à la liste des fournisseurs des Paramètres. Le plugin fournit le point de terminaison et les modèles ; votre clé API reste dans Zeus AI.",
      "desktop.control": "Permet d'appeler le catalogue Zeus AI contrôlé ; les opérations destructrices exigent toujours confirm=true et le bearer token MCP n'est pas exposé.",
      ...
      "keyboard.globalShortcut": "Enregistre des raccourcis clavier système qui déclenchent les commandes propres à ce plugin lorsque Zeus AI n'est pas au premier plan.",
  ...
  "status": {
    ...
    "dbSchemaTooNew":
      "Cette version de Zeus AI est plus ancienne que vos données locales (schéma de données {{found}}, cette version prend en charge {{supported}}). Installez la version plus récente de Zeus AI qui a ouvert ces données en dernier, ou une version ultérieure.",
    "archMismatch":
