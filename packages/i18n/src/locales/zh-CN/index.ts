...
export const zhCN = {
  app: {
    shellName: "Zeus AI",
    tagline: "本地 AI 编程助手",
    starting: "正在启动 Zeus AI…",
    loadingView: "正在加载页面…",
    uiCrashed: "界面出现了问题",
  },
  startup: {
    slowTitle: "仍在启动…",
    slowBody: "Zeus AI 连接本地服务比平时更久，可能还会自己完成启动——你可以继续等待，也可以先把日志收好。",
    stalledTitle: "Zeus AI 未能完成启动",
  ...
  tray: {
    ...
    open: "打开 Zeus AI",
    quit: "退出 Zeus AI",
    askTitle: "关闭后继续在后台运行 Zeus AI？",
    askBody:
      "关闭窗口后，Zeus AI 可以继续在系统托盘中运行，避免丢失任何内容。你随时可以在设置中更改此选项。",
    closeToTray: "关闭到托盘",
    confirmQuitTitle: "确定退出 Zeus AI？",
    confirmQuitBody:
  ...
  settings: {
    ...
    keepAwakeWhileRunningDesc: "Zeus AI 运行期间阻止电脑因空闲自动休眠。屏幕仍可能关闭；手动睡眠和合盖休眠不受影响。",
    imageModel: "生图模型",
    imageModelUnset: "未配置",
...
sklm: {
    ...
    pluginProviderKeyHint: "保存在 Zeus AI 中，由运行时使用。插件拿不到此密钥。",
  ...
  scheduled: {
    ...
    time: "执行时间",
    weekday: "星期",
    localTimeHint: "按电脑本地时区执行。请保持 Zeus AI 运行；错过的任务不补跑。",
  ...
  plugins: {
    ...
    permissionHelp: {
      ...
      "provider.register": "把此插件定义的服务添加到设置的服务列表。接口地址和模型由插件提供，API 密钥则留在 Zeus AI 中。",
      "desktop.control":
        "允许插件调用经过审查的 Zeus AI 操作目录；破坏性操作仍需 confirm=true，插件永远拿不到 MCP bearer token。",
      ...
      "keyboard.globalShortcut": "注册系统级快捷键，在 Zeus AI 未聚焦时触发本插件自己的命令。",
  ...
  status: {
    ...
    dbSchemaTooNew:
      "当前 Zeus AI 比本地数据更旧（数据库 schema {{found}}，此版本仅支持 {{supported}}）。请安装上次打开这些数据的更新版本，或更高版本。",
    archMismatch:
