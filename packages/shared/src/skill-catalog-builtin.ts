...
export const BUILTIN_SKILL_CATALOG: SkillCatalogFile = {
  ...
  skills: [
    ...
    },
    {
      id: "json-canvas",
      name: "JSON Canvas",
      description: "Create and edit JSON Canvas files (.canvas) with nodes, edges, groups, and connections for mind maps and visual flowcharts",
      author: "kepano",
      homepage: "https://github.com/kepano/obsidian-skills/tree/main/skills/json-canvas",
      categories: ["docs", "workflow"],
      verified: true,
      url: "https://cdn.jsdelivr.net/gh/kepano/obsidian-skills@main/skills/json-canvas/SKILL.md",
    },
    {
      id: "obsidian-markdown",
      name: "Obsidian Markdown",
      description: "Create and edit Obsidian Flavored Markdown with wikilinks, embeds, callouts, and frontmatter properties",
      author: "kepano",
      homepage: "https://github.com/kepano/obsidian-skills/tree/main/skills/obsidian-markdown",
      categories: ["docs", "writing"],
      verified: true,
      url: "https://cdn.jsdelivr.net/gh/kepano/obsidian-skills@main/skills/obsidian-markdown/SKILL.md",
    },
  ],
};
