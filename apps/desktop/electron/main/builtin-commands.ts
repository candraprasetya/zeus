...
export const BUILTIN_COMMANDS: BuiltinCommandDef[] = [
  ...
  { id: "builtin.zeus.mock", title: "Zeus Mock (Mockkiwi Banking Generator)", category: "Mobile Squad", keywords: ["mock", "mockkiwi", "api", "endpoint", "backend", "test"], source: "builtin", slash: "zeus-mock" },
];
